...
namespace ToursDatabase.Migrations
{
    ...
    [Migration("20240410102459_Locations")]
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 4, 10, 15, 54, 59, 727, DateTimeKind.Local).AddTicks(9745),
                            ...
                            UpdateDate = new DateTime(2024, 4, 10, 15, 54, 59, 727, DateTimeKind.Local).AddTicks(9756)
                        },
                        new
                        {
                            LocationId = new Guid("f77b8397-8467-4291-9698-155c20a70a68"),
                            Address = "456 Road, City, Country",
                            CreateDate = new DateTime(2024, 4, 10, 15, 54, 59, 727, DateTimeKind.Local).AddTicks(9762),
                            Description = "that is first street of place",
                            Latitude = 40.712800000000001,
                            Longitude = -74.006,
                            Name = "NYC Cruise by Circle Line",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 54, 59, 727, DateTimeKind.Local).AddTicks(9762)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Tour", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 54, 59, 727, DateTimeKind.Local).AddTicks(9986),
                            ...
                            TourDate = new DateTime(2024, 4, 10, 10, 24, 59, 727, DateTimeKind.Utc).AddTicks(9972),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 54, 59, 727, DateTimeKind.Local).AddTicks(9987)
                        });
                });
