...
namespace ToursDatabase.Migrations
{
    ...
    [Migration("20240410102612_Images")]
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ImageId = new Guid("f4efc921-21b9-4425-81bd-6c47081107a2"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3129),
                            ...
                            UpdateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3130)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3047),
                            ...
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3047)
                        },
                        new
                        {
                            LocationId = new Guid("0a2a8a1c-8be0-42c3-8c67-646822c797fb"),
                            Address = "456 Road, City, Country",
                            CreateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3067),
                            Description = "that is first street of place",
                            Latitude = 40.712800000000001,
                            Longitude = -74.006,
                            Name = "NYC Cruise by Circle Line",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3068)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReviewId = new Guid("463ea699-7776-4a01-9ec9-dfb200e986b8"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(2863),
                            Rating = 4.5,
                            ReviewDetail = "Great tour!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(2875)
                        },
                        new
                        {
                            ReviewId = new Guid("14427b55-d956-4f28-a4f9-d2b69657846e"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(2880),
                            Rating = 5.0,
                            ReviewDetail = "Amazing experience!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(2881)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Tour", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3104),
                            ...
                            TourDate = new DateTime(2024, 4, 10, 10, 26, 12, 329, DateTimeKind.Utc).AddTicks(3089),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 56, 12, 329, DateTimeKind.Local).AddTicks(3105)
                        });
                });
