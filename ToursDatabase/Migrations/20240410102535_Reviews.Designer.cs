...
namespace ToursDatabase.Migrations
{
    ...
    [Migration("20240410102535_Reviews")]
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3360),
                            ...
                            UpdateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3361)
                        },
                        new
                        {
                            LocationId = new Guid("b0fbfde6-1c23-429c-b1aa-573a09ea7eb0"),
                            Address = "456 Road, City, Country",
                            CreateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3367),
                            Description = "that is first street of place",
                            Latitude = 40.712800000000001,
                            Longitude = -74.006,
                            Name = "NYC Cruise by Circle Line",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3367)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReviewId = new Guid("9470bb12-0edc-4f45-9cab-2236b8c26c9e"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3127),
                            Rating = 4.5,
                            ReviewDetail = "Great tour!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3140)
                        },
                        new
                        {
                            ReviewId = new Guid("f4ac192d-3fee-4ebc-aca7-e12ad3d241d8"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3146),
                            Rating = 5.0,
                            ReviewDetail = "Amazing experience!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3146)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Tour", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3519),
                            ...
                            TourDate = new DateTime(2024, 4, 10, 10, 25, 35, 403, DateTimeKind.Utc).AddTicks(3502),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 55, 35, 403, DateTimeKind.Local).AddTicks(3520)
                        });
                });
