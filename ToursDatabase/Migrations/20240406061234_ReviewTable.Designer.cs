...
namespace ToursDatabase.Migrations
{
    ...
    [Migration("20240406061234_ReviewTable")]
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReviewId = new Guid("c2e0753e-39f2-4b94-9f9e-f6dc3e969c62"),
                            CreateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(4761),
                            Rating = 4.5,
                            ReviewDetail = "Great tour!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(4777)
                        },
                        new
                        {
                            ReviewId = new Guid("ac92c4cc-ce06-4397-88b0-e55434c67f6c"),
                            CreateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(4798),
                            Rating = 5.0,
                            ReviewDetail = "Amazing experience!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(4799)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Tour", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            CreateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(5058),
                            ...
                            UpdateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(5059)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.TourBooking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookingDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(5093),
                            CreateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(5098),
                            CustomerEmail = "john@example.com",
                            CustomerName = "John Doe",
                            Status = 1,
                            TourDate = new DateTime(2024, 4, 13, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(5094),
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 6, 11, 42, 34, 373, DateTimeKind.Local).AddTicks(5099)
                        });
                });
