...
namespace ToursDatabase.Migrations
{
    ...
    [Migration("20240410103245_Stops")]
    partial class Stops
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ImageId = new Guid("ba29ea09-1e62-41a8-8cd8-9452130301ac"),
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 616, DateTimeKind.Local).AddTicks(12),
                            ...
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 616, DateTimeKind.Local).AddTicks(12)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9911),
                            ...
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9912)
                        },
                        new
                        {
                            LocationId = new Guid("325e1236-cfd2-4180-86c8-01526b28e2bc"),
                            Address = "456 Road, City, Country",
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9917),
                            Description = "that is first street of place",
                            Latitude = 40.712800000000001,
                            Longitude = -74.006,
                            Name = "NYC Cruise by Circle Line",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9917)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReviewId = new Guid("323a900e-4897-4935-9307-0cbb3061265d"),
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9722),
                            Rating = 4.5,
                            ReviewDetail = "Great tour!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9735)
                        },
                        new
                        {
                            ReviewId = new Guid("15a9a5fb-bcaa-49c6-b0b9-f49e27b3823a"),
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9741),
                            Rating = 5.0,
                            ReviewDetail = "Amazing experience!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9741)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StopId = new Guid("b1f072fd-8f16-444f-80c9-25b42d80d4d4"),
                            ArrivalTime = new DateTime(2024, 4, 10, 16, 2, 45, 616, DateTimeKind.Local).AddTicks(30),
                            DepartureTime = new DateTime(2024, 4, 11, 2, 2, 45, 616, DateTimeKind.Local).AddTicks(31),
                            LocationId = new Guid("7209f8df-5d18-4279-a03d-707624fb86bb"),
                            Order = 2
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Tour", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9954),
                            ...
                            TourDate = new DateTime(2024, 4, 10, 10, 32, 45, 615, DateTimeKind.Utc).AddTicks(9941),
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9955)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.TourBooking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookingDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9985),
                            CreateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9992),
                            CustomerEmail = "john@example.com",
                            CustomerName = "John Doe",
                            Status = 1,
                            TourDate = new DateTime(2024, 4, 17, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9990),
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 16, 2, 45, 615, DateTimeKind.Local).AddTicks(9993)
                        });
                });
