...
namespace ToursDatabase.Migrations
{
    ...
    [Migration("20240410102827_TourBooking")]
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ImageId = new Guid("2bc55382-767e-48aa-95de-5f2dee853db8"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6472),
                            ...
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6472)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6353),
                            ...
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6354)
                        },
                        new
                        {
                            LocationId = new Guid("909654dc-70be-487b-be37-a20be7652732"),
                            Address = "456 Road, City, Country",
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6373),
                            Description = "that is first street of place",
                            Latitude = 40.712800000000001,
                            Longitude = -74.006,
                            Name = "NYC Cruise by Circle Line",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6373)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReviewId = new Guid("46797bfc-543a-431d-998c-98f560b083d3"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6165),
                            Rating = 4.5,
                            ReviewDetail = "Great tour!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6182)
                        },
                        new
                        {
                            ReviewId = new Guid("166cd234-c8a0-4fd0-a883-7643ff7132ae"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6186),
                            Rating = 5.0,
                            ReviewDetail = "Amazing experience!",
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6187)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.Tour", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6414),
                            ...
                            TourDate = new DateTime(2024, 4, 10, 10, 28, 27, 500, DateTimeKind.Utc).AddTicks(6396),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6415)
                        });
                });
            ...
            modelBuilder.Entity("ToursDatabase.Domain.Entities.TourBooking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookingDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6444),
                            CreateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6448),
                            CustomerEmail = "john@example.com",
                            CustomerName = "John Doe",
                            Status = 1,
                            TourDate = new DateTime(2024, 4, 17, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6445),
                            TourId = new Guid("9c0cf771-2a31-44c9-adfd-b08c30397392"),
                            UpdateDate = new DateTime(2024, 4, 10, 15, 58, 27, 500, DateTimeKind.Local).AddTicks(6450)
                        });
                });
